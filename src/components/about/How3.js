...
export default function How3(props) {
  return (
    <>
  ...
  <div className="container mx-auto flex px-5 py-2 xl:flex-row flex-col items-center">
    ...
    <div className="lg:flex-grow xl:w-1/2 xl:pl-24  flex flex-col xl:items-start xl:text-left items-center text-center">
      <h1 className={`title-font sm:text-4xl text-3xl mb-4 font-medium  text-${props.modetext}`}>How I build this app 
        <br />While Learning React JS
      </h1>
      <p className={`mb-8 leading-relaxed  text-${props.modetext}`}>Lorem ipsum dolor sit amet consectetur adipisicing elit. Distinctio eveniet dolore at suscipit modi illum non inventore, nisi aspernatur ipsum similique voluptatum et odio laboriosam!</p>
      <div className="flex justify-center">
        <Link to='/about/how2' className="inline-flex text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg">Back</Link>
        <Link to='/about/how4' className="ml-4 inline-flex text-white bg-amber-500 border-0 py-2 px-6 focus:outline-none hover:bg-gray-200 rounded text-lg">Next</Link>
      </div>
    </div>
  </div>
</section>
